...
wine_patch_data[] =
{
    ...
    { "Andrew Cook", "kernel32/tests: Add tests for IsProcessInJob.", 1 },
    { "Andrew Cook", "kernel32/tests: Add tests for JOB_OBJECT_LIMIT_ACTIVE_PROCESS.", 1 },
    { "Andrew Cook", "kernel32/tests: Add tests for JOB_OBJECT_LIMIT_BREAKAWAY_OK.", 1 },
    { "Andrew Cook", "kernel32/tests: Add tests for JOB_OBJECT_LIMIT_KILL_ON_JOB_CLOSE.", 1 },
    { "Andrew Cook", "kernel32/tests: Add tests for QueryInformationJobObject.", 1 },
    { "Andrew Cook", "kernel32/tests: Add tests for TerminateJobObject.", 1 },
    { "Andrew Cook", "kernel32/tests: Add tests for job inheritance.", 1 },
    { "Andrew Cook", "kernel32/tests: Add tests for job object completion ports.", 1 },
    { "Andrew Cook", "server: Basic implementation of job objects.", 2 },
    { "Andrew Cook", "server: Implement JOB_OBJECT_LIMIT_KILL_ON_JOB_CLOSE.", 1 },
    { "Andrew Cook", "server: Implement completion messages for job objects.", 1 },
    { "Andrew Cook", "server: Properly track handle count of objects.", 1 },
    { "Andrew Cook", "server: Support NULL job handles in IsProcessInJob.", 1 },
    ...
    { "Dmitry Timoshkov", "windowscodecs: Ignore unsupported alpha channel in tiff_get_decode_info.", 1 },
    ...
    { "Erich E. Hoover", "kernel32: Invalid console handles for new processes are 0, not INVALID_HANDLE_VALUE.", 1 },
    { "Erich E. Hoover", "kernel32: NeedCurrentDirectoryForExePath does not use the registry.", 1 },
    { "Erich E. Hoover", "krnl386: Invalid console handles should translate into real handles when creating a new process.", 1 },
    ...
    { "Mark Jansen", "kernel32/tests: Parameter validation tests for FindActCtxSectionString.", 1 },
    ...
    { "Michael Müller", "msvcrt: Implement _mbctokata and _mbctohira.", 1 },
    { "Michael Müller", "netprofm: Add IConnectionPoint/INetworkListManagerEvents stub interface.", 1 },
    ...
    { "Michael Müller", "ntdll: Define a couple more information classes.", 1 },
    ...
    { "Sebastian Lackner", "browseui: Avoid race-conditions when progress dialog is released before thread terminates.", 1 },
    ...
    { "Sebastian Lackner", "dinput: Ensure X11 input events are handled even without explicit message loop.", 2 },
    ...
    { "Sebastian Lackner", "kernel32/tests: Add tests for adding a terminated process to a job object.", 1 },
    { "Sebastian Lackner", "kernel32/tests: Add tests for sending and receiving large messages.", 1 },
    { "Sebastian Lackner", "kernel32/tests: Add tests for waiting on an job object.", 1 },
    { "Sebastian Lackner", "kernel32/tests: Allow multiple subprocess commands in process tests.", 1 },
    ...
    { "Sebastian Lackner", "kernel32: Add stub for PowerCreateRequest.", 1 },
    ...
    { "Sebastian Lackner", "msctf: Avoid unloading library while textservices are activated.", 1 },
    ...
    { "Sebastian Lackner", "ntdll: Fix check for end_frame in RtlUnwindEx on x86_64.", 2 },
    ...
    { "Sebastian Lackner", "ntdll: Handle write watches in virtual_uninterrupted_write_memory.", 1 },
    ...
    { "Sebastian Lackner", "ntdll: Implement TpSetPool[Min|Max]Threads.", 1 },
    ...
    { "Sebastian Lackner", "ntdll: RtlFindActivationContextSectionString should accept a NULL pointer as data.", 1 },
    ...
    { "Sebastian Lackner", "server: Fix handling of GetMessage after previous PeekMessage call.", 1 },
    { "Sebastian Lackner", "server: Implement locking and synchronization of keystate buffer.", 1 },
    { "Sebastian Lackner", "server: Implement waiting for job objects.", 1 },
    ...
    { "Sebastian Lackner", "user32: After calling LL hooks the key state cache has to be invalidated globally.", 1 },
    ...
    { "Sebastian Lackner", "wineconsole: Increase buffer to allow larger commandline strings.", 1 },
