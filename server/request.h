...
static const req_handler req_handlers[REQ_NB_REQUESTS] =
{
    ...
    (req_handler)req_job_set_limits,
...
C_ASSERT( FIELD_OFFSET(struct job_set_limits_request, handle) == 12 );
C_ASSERT( FIELD_OFFSET(struct job_set_limits_request, limit_flags) == 16 );
C_ASSERT( sizeof(struct job_set_limits_request) == 24 );
C_ASSERT( FIELD_OFFSET(struct job_set_completion_request, handle) == 12 );
C_ASSERT( FIELD_OFFSET(struct job_set_completion_request, port) == 16 );
C_ASSERT( FIELD_OFFSET(struct job_set_completion_request, key) == 24 );
...
C_ASSERT( FIELD_OFFSET(struct link_file_request, handle) == 12 );
C_ASSERT( sizeof(struct link_file_request) == 16 );
