...
static const WCHAR wine_atl_iocsW[] = {'_','W','I','N','E','_','A','T','L','_','I','O','C','S','\0'};
...
static content get_content_type(LPCOLESTR name, CLSID *control_id)
{
        ...
        REFIID iidSink, IUnknown *punkSink)
{
    ...
    if (ppUnkContainer) *ppUnkControl = NULL;
